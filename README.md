...
The database table structure has been created following [MySQL world database standard]([https://dev.mysql.com/doc/index-other.html]) - MySQL world database standard 
